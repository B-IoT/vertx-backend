...
allprojects {
    extra["vertxVersion"] = if (project.hasProperty("vertxVersion")) project.property("vertxVersion") else "4.1.1"
    extra["junitJupiterVersion"] = "5.7.2"
    extra["logbackClassicVersion"] = "1.2.5"
    ...
    extra["micrometerPrometheusVersion"] = "1.7.3"
